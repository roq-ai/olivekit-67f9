...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`OliveKit`}</title>

        <meta
          name="description"
          content="Empower Your Business with OliveKit: The Ultimate Platform for Online Free and Premium Small Services, Streamlining Success and Growth"
        />
      </Head>
      ...
      <Stack minH={'100vh'} direction={{ base: 'column', md: 'row' }}>
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Empower Your Business with OliveKit: The Ultimate Platform for Online Free and Premium Small Services, Streamlining Success and Growth`}
            </Text>
        ...
        <Flex position="relative" flex={1}>
          <Image
            src={
              'https://images.unsplash.com/photo-1516321497487-e288fb19713f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzZXJ2aWNlcyUyQ29ubGluZXxlbnwwfHx8fDE2ODc0NzEyMjZ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt={'Login Image'}
            objectFit={'cover'}
          />
